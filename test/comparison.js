...
describe("DOM Manipulation Scenarios: Element Identity", function () {
  ...
  function testBoth(name, beforeHtml, afterHtml, getTrackedElements, checkPreserved) {
    it(name, function () {
      ...
      OriginalIdiomorph.morph(containerIdi, afterHtml, { morphStyle: 'innerHTML' });
      ...
      if (idiPreserved) results.idiomorph.passed++; else results.idiomorph.failed++;
      if (hyperPreserved) results.hypermatch.passed++; else results.hypermatch.failed++;
  ...
  describe("Simple Operations", function () {
    ...
    testBoth("1. Append one item to list",
      "<ul><li>A</li><li>B</li></ul>",
      "<ul><li>A</li><li>B</li><li>C</li></ul>",
      (el) => [el.children[0], el.children[1]],
      (el, tracked) => el.children[0] === tracked[0] && el.children[1] === tracked[1]
    );

    testBoth("2. Prepend one item to list",
      "<ul><li>A</li><li>B</li></ul>",
      "<ul><li>NEW</li><li>A</li><li>B</li></ul>",
      (el) => [el.children[0], el.children[1]],
      (el, tracked) => el.children[1] === tracked[0] && el.children[2] === tracked[1]
    );

    testBoth("3. Remove first item from list",
      "<ul><li>A</li><li>B</li><li>C</li></ul>",
    ...
    testBoth("4. Remove middle item from list",
      "<ul><li>A</li><li>B</li><li>C</li></ul>",
    ...
    testBoth("5. Remove last item from list",
      "<ul><li>A</li><li>B</li><li>C</li></ul>",
      "<ul><li>A</li><li>B</li></ul>",
      (el) => [el.children[0], el.children[1]],
      (el, tracked) => el.children[0] === tracked[0] && el.children[1] === tracked[1]
    ...
    testBoth("6. Swap two items",
      "<ul><li>A</li><li>B</li></ul>",
      "<ul><li>B</li><li>A</li></ul>",
      (el) => [el.children[0], el.children[1]],
      (el, tracked) => el.children[0] === tracked[1] && el.children[1] === tracked[0]
    );

    testBoth("7. Reverse three items",
      "<ul><li>A</li><li>B</li><li>C</li></ul>",
      "<ul><li>C</li><li>B</li><li>A</li></ul>",
      (el) => [el.children[0], el.children[1], el.children[2]],
      (el, tracked) => el.children[0] === tracked[2] && el.children[1] === tracked[1] && el.children[2] === tracked[0]
    );

    testBoth("8. Insert item in middle",
      "<ul><li>A</li><li>C</li></ul>",
      "<ul><li>A</li><li>B</li><li>C</li></ul>",
      (el) => [el.children[0], el.children[1]],
      (el, tracked) => el.children[0] === tracked[0] && el.children[2] === tracked[1]
    );

    testBoth("9. Append with unique tags",
    ...
    testBoth("10. Reorder unique tags",
      "<div><header>H</header><main>M</main><footer>F</footer></div>",
  ...
  describe("Class-Differentiated Elements", function () {
    ...
    testBoth("11. Swap divs with different classes",
    ...
    testBoth("12. Prepend to class-differentiated list",
      "<div><div class='a'>A</div><div class='b'>B</div></div>",
    ...
    testBoth("13. Remove first from class-differentiated list",
    ...
    testBoth("14. Rotate three class-differentiated elements",
      "<div><div class='a'>A</div><div class='b'>B</div><div class='c'>C</div></div>",
      "<div><div class='c'>C</div><div class='a'>A</div><div class='b'>B</div></div>",
      (el) => [el.children[0], el.children[1], el.children[2]],
      (el, tracked) => el.children[0] === tracked[2] && el.children[1] === tracked[0] && el.children[2] === tracked[1]
    );

    testBoth("15. Insert into class-differentiated list",
  ...
  describe("Text-Differentiated Elements", function () {
    ...
    testBoth("16. Swap divs by text content only",
    ...
    testBoth("17. Prepend to text-differentiated list",
    ...
    testBoth("18. Remove middle from text-differentiated list",
    ...
    testBoth("19. Shuffle four text-differentiated items",
      "<ul><li>A</li><li>B</li><li>C</li><li>D</li></ul>",
      "<ul><li>C</li><li>A</li><li>D</li><li>B</li></ul>",
      (el) => [el.children[0], el.children[1], el.children[2], el.children[3]],
      (el, tracked) => el.children[0] === tracked[2] && el.children[1] === tracked[0] && el.children[2] === tracked[3] && el.children[3] === tracked[1]
    );

    testBoth("20. Insert multiple items",
      "<ul><li>A</li><li>D</li></ul>",
      "<ul><li>A</li><li>B</li><li>C</li><li>D</li></ul>",
      (el) => [el.children[0], el.children[1]],
      (el, tracked) => el.children[0] === tracked[0] && el.children[3] === tracked[1]
    );
  });
  ...
  describe("Attribute-Differentiated Elements", function () {
    ...
    testBoth("21. Swap links by href",
    ...
    testBoth("22. Swap images by src",
    ...
    testBoth("23. Swap inputs by type",
    ...
    testBoth("24. Swap inputs by name",
    ...
    testBoth("25. Prepend to href-differentiated links",
  ...
  describe("Nested Structures", function () {
    ...
    testBoth("26. Swap nested card structures",
    ...
    testBoth("27. Reorder items 3 levels deep",
      ...
      (el, tracked) => {
        const div = el.querySelector('div');
        return div.children[0] === tracked[2] && div.children[1] === tracked[0] && div.children[2] === tracked[1];
      }
    );

    testBoth("28. Prepend item 3 levels deep",
    ...
    testBoth("29. Remove first from nested list",
    ...
    testBoth("30. Shuffle nested wrappers",
  ...
  after(function () {
    console.log('\n');
    console.log('╔══════════════════════════════════════════════════════════════════════════════╗');
    console.log('║                    ELEMENT IDENTITY PRESERVATION COMPARISON                   ║');
    console.log('╠══════════════════════════════════════════════════════════════════════════════╣');
    console.log('║  #  │ Test Name                                    │ Idiomorph │ HyperMatch ║');
    console.log('╠══════════════════════════════════════════════════════════════════════════════╣');
    ...
    for (let i = 0; i < results.idiomorph.tests.length; i++) {
      ...
      const name = idi.name.substring(idi.name.indexOf('.') + 2).padEnd(44).substring(0, 44);
    ...
    console.log(`║                                        TOTAL │  ${idiTotal}   │   ${hyperTotal}   ║`);
    console.log('╚══════════════════════════════════════════════════════════════════════════════╝');
    console.log('\n');
  });
});
