...
describe("HyperMatch Edge Cases", function () {
  ...
  describe("Issue 1: Asymmetric text handling", function () {
    ...
    it("should NOT grant unique bonus when text mismatches (multiple candidates)", function () {
      ...
      let old = make(
        "<div><span class='a'>Alpha</span><span class='a'>Beta</span></div>",
      );
      let alpha = old.children[0];
      let beta = old.children[1];
      Idiomorph.morph(
        old,
        "<div><span class='a'>Beta</span><span class='a'>Alpha</span></div>",
      );
  ...
  describe("Issue 2 & 3: ID element handling", function () {
    it("should let ID-based matching handle elements with IDs", function () {
      ...
      Idiomorph.morph(
        old,
        "<ul><li id='item2'>B</li><li id='item1'>A</li></ul>",
      );
    ...
    it("should not let ID elements inflate unique candidate count", function () {
      ...
      let old = make(
        "<div><span class='a'>Text</span><span id='special' class='a'>Text</span></div>",
      );
    ...
    it("should correctly match non-ID elements even when ID elements exist", function () {
      let old = make(
        "<ul><li id='fixed'>Fixed</li><li>Dynamic A</li><li>Dynamic B</li></ul>",
      );
      let dynamicA = old.children[1];
      let dynamicB = old.children[2];
      Idiomorph.morph(
        old,
        "<ul><li id='fixed'>Fixed</li><li>Dynamic B</li><li>Dynamic A</li></ul>",
      );
  ...
  describe("Issue 4: Nested element text hints", function () {
    it("should use nested text content for matching wrapper elements", function () {
      let old = make(
        "<div><div class='card'><span>Card A</span></div><div class='card'><span>Card B</span></div></div>",
      );
      let card1 = old.children[0];
      let card2 = old.children[1];
      Idiomorph.morph(
        old,
        "<div><div class='card'><span>Card B</span></div><div class='card'><span>Card A</span></div></div>",
      );
    ...
    it("should differentiate wrapper elements by their children's text", function () {
      let old = make(
        "<ul><li><span>Apple</span></li><li><span>Banana</span></li></ul>",
      );
      let li1 = old.children[0];
      let li2 = old.children[1];
      Idiomorph.morph(
        old,
        "<ul><li><span>Banana</span></li><li><span>Apple</span></li></ul>",
      );
    ...
    it("should handle deeply nested text content", function () {
      let old = make(
        "<div><div class='wrapper'><div class='inner'><p>Content A</p></div></div><div class='wrapper'><div class='inner'><p>Content B</p></div></div></div>",
      );
      let wrapper1 = old.children[0];
      let wrapper2 = old.children[1];
      Idiomorph.morph(
        old,
        "<div><div class='wrapper'><div class='inner'><p>Content B</p></div></div><div class='wrapper'><div class='inner'><p>Content A</p></div></div></div>",
      );
  ...
  describe("Combined edge case scenarios", function () {
    it("should handle mixed ID and non-ID siblings correctly", function () {
      let old = make(
        "<ul><li id='a'>A</li><li>B</li><li id='c'>C</li><li>D</li></ul>",
      );
      let liB = old.children[1];
      let liD = old.children[3];
      Idiomorph.morph(
        old,
        "<ul><li id='c'>C</li><li>D</li><li id='a'>A</li><li>B</li></ul>",
      );
    ...
    it("should correctly identify the right element among multiple candidates", function () {
      ...
      let old = make(
        "<nav><a href='/page'>Home</a><a href='/page'>About</a></nav>",
      );
      let home = old.children[0];
      let about = old.children[1];
      Idiomorph.morph(
        old,
        "<nav><a href='/page'>About</a><a href='/page'>Home</a></nav>",
      );
  ...
  describe("Slot identity", function () {
    it("preserves element across class change at same position", function () {
      ...
      Idiomorph.morph(
        old,
        "<div><div class='card active'><span>x</span></div></div>",
      );
    ...
    it("preserves nested element when middle wrapper class changes", function () {
      let old = make(
        "<div><div class='outer-a'><div class='inner'><span>x</span></div></div></div>",
      );
      ...
      Idiomorph.morph(
        old,
        "<div><div class='outer-b'><div class='inner'><span>x</span></div></div></div>",
      );
